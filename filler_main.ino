...
public: 
    Filler(byte pinc02, byte pinbuch, byte pinpurge, byte pinvertical) { this->pinc02 = pinc02; this->pinbuch = pinbuch; this->pinpurge = pinpurge; this->pinvertical = pinvertical;
